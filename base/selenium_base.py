...
class SeleniumBase():
    def __init__(self, driver):
        self.driver = driver
        self.__wait = WebDriverWait(driver, 17, 0.3, ignored_exceptions=StaleElementReferenceException)
    ...
    def are_presents(self, find_by: str, locator: str, locator_name=None) -> List[WebElement]:
